...
public class ArbolFruta extends Tile
{
    public ArbolFruta()
    {
        super("A", "/imagenes/SurvivalArbolFrutaSprite.png", true, true, true, 8);
    }
    ...
    public ReturnItem[] destruir(Item item) 
    {
        ...
        else
        {
            ...
            {
                rI[0] = new ReturnItem(new Items.Madera(), 2, 1);
                rI[1] = new ReturnItem(new Comidas.Fruta(), 1, 1);
                
                if((int)(Math.random() * 100) + 1 <= 40)
                {
                    rI[2] = new ReturnItem(new Items.Planta(), (int) (Math.random() * 3) + 1, 1);
                }
